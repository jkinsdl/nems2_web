...
@Component({
  selector: 'app-driving-charging-statistics',
  templateUrl: './driving-charging-statistics.component.html',
  styleUrls: ['./driving-charging-statistics.component.css']
})
export class DrivingChargingStatisticsComponent implements OnInit {
