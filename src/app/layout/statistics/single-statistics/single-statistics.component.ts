...
@Component({
  selector: 'app-single-statistics',
  templateUrl: './single-statistics.component.html',
  styleUrls: ['./single-statistics.component.css'],
})
export class SingleStatisticsComponent implements OnInit {
  ...
  columnDefs2: ColDef[] = [
    ...
    { field: 'end_date', headerName : 'End Date' },
    { field: 'driving_time', headerName : 'Driving Time(min)' },
    { field: 'average_ampere', headerName : 'Average Ampere(A)' },
    { field: 'consumedPower', headerName: 'Consumed Power'},
    { field: 'travelDistance', headerName : 'Travel Dstance(K)'}
  ];
