...
@Component({
  selector: 'app-abnormal-vehicle-state',
  templateUrl: './abnormal-vehicle-state.component.html',
...
export class AbnormalVehicleStateComponent implements OnInit {
  ...
  @ViewChild('abnormalVehicleStateGrid', { read: ElementRef }) abnormalVehicleStateGrid : ElementRef;
  ...
  getPageSize(){
    this.gridHeight = this.abnormalVehicleStateGrid.nativeElement.offsetHeight;
  ...
  getGbpacketInvalid(){
    ...
    this.searchFilter.excludeState = []
    this.searchFilter.excludeState.push("LOCATION")
    this.searchFilter.excludeState.push("MILEAGE_JUMP")
